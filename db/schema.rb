...
ActiveRecord::Schema[7.2].define(version: 2025_05_14_135956) do
  ...
  create_table "prepared_scramble_sets", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "competition_id", null: false
    t.string "event_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["competition_id", "event_id", "round_type_id", "ordered_index"], name: "idx_on_competition_id_event_id_round_type_id_ordere_fe33a3b3e8", unique: true
    t.index ["competition_id", "event_id", "round_type_id"], name: "idx_on_competition_id_event_id_round_type_id_3a11f51713"
    t.index ["competition_id"], name: "index_prepared_scramble_sets_on_competition_id"
    t.index ["event_id"], name: "fk_rails_7a55abc2f3"
    t.index ["external_upload_id"], name: "index_prepared_scramble_sets_on_external_upload_id"
    t.index ["matched_round_id"], name: "index_prepared_scramble_sets_on_matched_round_id"
    t.index ["round_type_id"], name: "fk_rails_30f08dbdd8"
  end

  create_table "prepared_scrambles", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["scramble_set_id", "scramble_number", "is_extra"], name: "idx_on_scramble_set_id_scramble_number_is_extra_2a2c0812cc", unique: true
    t.index ["scramble_set_id"], name: "index_prepared_scrambles_on_scramble_set_id"
  end
  ...
  add_foreign_key "prepared_scramble_sets", "events"
  add_foreign_key "prepared_scramble_sets", "round_types"
  add_foreign_key "prepared_scramble_sets", "rounds", column: "matched_round_id"
  add_foreign_key "prepared_scramble_sets", "scramble_file_uploads", column: "external_upload_id"
  add_foreign_key "prepared_scrambles", "prepared_scramble_sets", column: "scramble_set_id"
